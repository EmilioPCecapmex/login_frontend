...
import { Button, Collapse, Divider, Grid, IconButton, List, ListItemButton, ListItemText, Tooltip, Typography } from "@mui/material";
...
import AyudaModal from "../Ayuda/AyudaModal";
...
//   }, [window.location.href]);
  ...
  return (
    <div>
      <SliderProgress open={slideropen} texto={""}></SliderProgress>
...
export const handleClickDelet = (URLVideo: string, route: string) => {
  let data = {
    TOKEN: JSON.parse(String(localStorage.getItem('jwtToken')||'')),
    RUTA: route,
    NOMBRE: URLVideo,
  };
