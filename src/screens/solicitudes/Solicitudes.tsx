          ...
          >
            ...
            >
              ...
              >
                ...
                <Select value={appSelectedIndex} label="Filtar por aplicacion">
                  {apps.map((item, x) => {
                    return (
                      <MenuItem
                        key={x}
                        ...
                        <Box sx={{ display: "flex", width: "10%", mr: "8vw" }}>
                          ...
                          <IconButton
                            onClick={() => {
                              let a = selectedIndex;
                              a = a + 1;
                              if (a < solicitudes.length) setSelectedIndex(a);
                            }}
                          >
