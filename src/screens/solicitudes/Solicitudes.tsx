...
export const Solicitudes = () => {
  ...
  const modificarSolicitud = (estado: string, tipoSoli: string) => {
    axios
      .put(
        "http://10.200.4.200:5000/api/solicitud-transaction",
        {
  ...
  return (
    ...
    >
            ...
            >
              ...
              >
                ...
                <Select
                  ...
                  onChange={(c) => filtroXApp(c.target.value)}
                >
                      ...
                      >
                        ...
                        >
                          ...
                          <TextField
                            ...
                            value={moment(
                              detalleSolicitud[0]?.FechaDeCreacion,
                              moment.ISO_8601
                            )
                              .format("DD/MM/YYYY HH:mm:SS")
                              .toString()}
                        ...
                        >
                          <TextField
                            ...
                            sx={{
                              ...
                              fontSize: "1.5vw",
                              width: "25%",
                              backgroundColor: onChangeInfo.Nombre
                                ? "#fde6a2"
                                : "blue",
                            }}
                          ...
                          <TextField
                            ...
                            sx={{
                              ...
                              fontSize: "1.5vw",
                              width: "25%",
                              backgroundColor: onChangeInfo.ApellidoPaterno
                                ? "#fde6a2"
                                : "blue",
                            }}
                          ...
                          <TextField
                            ...
                            sx={{
                              ...
                              fontSize: "1.5vw",
                              width: "25%",
                              backgroundColor: onChangeInfo.ApellidoMaterno
                                ? "#fde6a2"
                                : "blue",
                            }}
                        ...
                        >
                          <TextField
                            ...
                            sx={{
                              ...
                              fontSize: "1.5vw",
                              width: "25%",
                              backgroundColor: onChangeInfo.NombreUsuario
                                ? "#fde6a2"
                                : "blue",
                            }}
                          ...
                          <TextField
                            ...
                            sx={{
                              ...
                              fontSize: "1.5vw",
                              width: "25%",
                              backgroundColor: onChangeInfo.Celular
                                ? "#fde6a2"
                                : "blue",
                            }}
                        ...
                        >
                          <TextField
                            ...
                            sx={{
                              ...
                              fontSize: "1.5vw",
                              width: "25%",
                              backgroundColor: onChangeInfo.Curp
                                ? "#fde6a2"
                                : "blue",
                            }}
                          ...
                          <TextField
                            ...
                            sx={{
                              ...
                              fontSize: "1.5vw",
                              width: "25%",
                              backgroundColor: onChangeInfo.Rfc
                                ? "#fde6a2"
                                : "blue",
                            }}
                          ...
                          <TextField
                            ...
                            sx={{
                              ...
                              fontSize: "1.5vw",
                              width: "15%",
                              backgroundColor: onChangeInfo.Telefono
                                ? "#fde6a2"
                                : "blue",
                            }}
                          ...
                          <TextField
                            ...
                            sx={{
                              ...
                              fontSize: "1.5vw",
                              width: "10%",
                              backgroundColor: onChangeInfo.Ext
                                ? "#fde6a2"
                                : "blue",
                            }}
      ...
      <Dialog open={openDialogRechazar} onClose={handleCloseOpenDialogRechazar}>
        <DialogTitle>Confirmación</DialogTitle>
        <DialogContent>
          <DialogContentText>
            ¿Seguro que desea rechazar la solicitud de{" "}
        ...
        <DialogActions>
          ...
          <Button
            ...
            onClick={() => {
              ...
              handleCloseOpenDialogModificar();
            }}
          >
            Aceptar
          </Button>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            ¿Seguro que desea pedir modificacion del registro de{" "}
            {detalleSolicitud[0]?.Nombre +
              " " +
              detalleSolicitud[0]?.ApellidoPaterno}{" "}
            a la aplicacion {detalleSolicitud[0]?.NombreApp}?
          </DialogContentText>
          <TextField
            sx={{ width: "100%" }}
            label="Agregar comentario"
      ...
      <Dialog open={openDialogAceptar} onClose={handleCloseOpenDialogAceptar}>
        <DialogTitle>Confirmación</DialogTitle>
        <DialogContent>
          <DialogContentText>
            ¿Seguro que desea aceptar el registro de{" "}
            {detalleSolicitud[0]?.Nombre +
              " " +
              detalleSolicitud[0]?.ApellidoPaterno}{" "}
            a la aplicacion {detalleSolicitud[0]?.NombreApp}?
